...
if($result_usuario->rowCount() !=0)
{
    ...
    {
        $_SESSION['msg'] = "<p style='color:green; texte-align:center;'>Usuário excluido com sucesso!</p>";
        header("Location: listar2.php");
    }else{
        $_SESSION['msg'] = "<p style='color:#f00; texte-align:center;'>Usuário NÃO excluido!!!</p>";
        header("Location: listar2.php");
    }
}else{
    $_SESSION['msg'] = "<p style='color:#f00; texte-align:center;'>Usuário NÃO econtrado!!!</p>";
    header("Location: listar2.php");
}
